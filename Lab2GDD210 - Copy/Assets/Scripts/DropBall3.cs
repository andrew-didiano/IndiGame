...
public class DropBall3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (catchCount == 10)
        {
            SceneManager.LoadScene("Win3"); //if the score is 10, load the third win screen.
        }
        else if (catchCount < 0)
        {
            SceneManager.LoadScene("Lose3"); //if the score is under 0, load the third lose screen.
        }
